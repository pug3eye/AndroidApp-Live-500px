package com.pug3eye.liveat500px.view;
...
public class PhotoListItem extends BaseCustomViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newHeightMeasureSpec = MeasureSpec.makeMeasureSpec(  // Make measureSpec give width is 2/3height
